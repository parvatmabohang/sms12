  ...
  <div style="height: 100em;" class="content-wrapper">
                        ...
                        <div class="panel-body">
                            <div class="input-group input-group-lg">
                                        <div class="input-group-btn">
                                            ...
                                            <!-- /btn-group -->
                                        @if($student_reg_no)    
                                        <input id="student_search_id" name="student_search_id" type="text" class="form-control" value="{{ $student_reg_no }}">
                                        @else
    ...
    <section id="printTable" class="invoice">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <form method="get" action="{{ url('admin/fees/invoice_print') }}">
          ...
          <a href="{{ url('admin/fees/invoice_print') }}" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
