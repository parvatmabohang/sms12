    ...
    <!-- Main content -->
      <div class="content">
            ...
            <div class="box-header">
                ...
                Add Subject</button>
                <a href="<?php echo e(url('admin/academic/subjects/assign_bulk_subjects')); ?>" style="border-radius: 5px;width: 120px;margin-top: -3.4em;margin-left: 10em;" class="btn bg-purple btn-flat margin" >Bulk Addition</a>
                </div>
            </div>
             <!-- /.modal -->
